...
<div class="container">
        ...
        <div class="col-md-6" >
            @csrf
                <form action="" method="GET">
                    <input type="text" name="search" placeholder="Search by authors..." required/>
   ...
   <div class="row">
       <div class="col-md-12">
            <p class="align-items-center">We are an independent national organisation set up in 2021 to support Friends of Library groups and to campaign for improved services in publicly funded libraries. </p>
       </div>
   </div>
</div> 
