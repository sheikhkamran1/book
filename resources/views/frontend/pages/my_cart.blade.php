...
<div class="container py-5">
    <div class="card shadow product_data">
        <div class="card-body">
            <div class="row">
                <div class="col-md-2">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS92KmFlD4i0QHrqaYh9F-8nDMNB0NstefhSw&usqp=CAU" alt="" width="50px">
                </div>
                <div class="col-md-3">
                    <h3>science</h3>
                </div>
                ...
                <div class="col-md-2  align-items-center">
                    <button class="btn btn-danger text-light delete-cart-item"><i class="far fa-trash-alt"></i> Remove</button>
                </div>
            </div><hr>
...
<div class="container">
    ...
    <div class="container py-5">
        <div class="card shadow product_data">
            ...
            <div class="card-body">
              @php $total = 0; @endphp
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                      <h5>Rs:{{$cartitems->book->issue_price}}</h5>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group text-center mb-3" style="width: 130px">
                            ...
                            <input type="text" name="quantity" class="form-control  qty-input text-center" value="{{$cartitems->prod_qty}}">
            ...
            <div class="card-footer">
              <strong style="color: black">Total Price: {{$total}}</strong><hr>
          <a href="/checkout" class="btn btn-outline-success float-end">Proceed to checkout</a>
            </div>
            @else
            {
